...
_APPLE_RE = re.compile(r"^apple", re.IGNORECASE)
...
def build_model_factory(cfg: AgentConfig) -> ModelFactory | None:
    ...
    if cfg.anthropic_api_key or cfg.openai_api_key or cfg.openrouter_api_key or cfg.cerebras_api_key or cfg.apple_api_key or cfg.provider == "apple":
        return _factory
    return None
...
def build_engine(cfg: AgentConfig) -> RLMEngine:
    tools = WorkspaceTools(
        ...
        mariadb_host=cfg.mariadb_host,
        mariadb_port=cfg.mariadb_port,
        mariadb_user=cfg.mariadb_user,
        mariadb_password=cfg.mariadb_password,
        mariadb_database=cfg.mariadb_database,
    )
